...
fun RankerMusicScreen(
    ...
    val musicRanker = musics.sortedByDescending { it.playCount }
    ...
    musicService.musics = musicRanker
    ...
    val displayedMusics = if (showAll) musics.sortedByDescending { it.playCount } else musics.sortedByDescending { it.playCount }.take(15)
                    ...
                    item {
                        ...
                        Button(
                            ...
                            Row(
                                ...
                                Text(
                                    text = if (showAll) "COLLAPSE" else "SEE MORE",
                                    fontSize = 12.sp,
                                    color = Color.White,
                                )
